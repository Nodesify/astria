...
The docs site now ships per-release versions: **1.0.0** is the default, 0.8.0 stays available as an archive, and `Next` tracks what is landing after 1.0.0. See the [docs](/docs/intro) — and [benchmarks](/docs/explanation/benchmarks) for how every number is measured and reproduced.

astria is developed at [Nodesify/astria](https://github.com/Nodesify/astria) — issues, the [worked examples](https://github.com/Nodesify/astria/tree/main/worked), and the head-to-head benchmark data all live in the repo. It is built by [Nodesify](https://nodesify.com).
