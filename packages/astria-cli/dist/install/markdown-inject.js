...
exports.SECTION_MARKER = '<!-- astria:managed -->';
...
function stripMarker(sectionText) {
    return sectionText
        ...
        .filter((line) => {
        const t = line.trim();
        return t !== exports.SECTION_MARKER && t !== LEGACY_SECTION_MARKER;
    })
        .join('\n')
        .trim();
}
function isManaged(sectionText) {
    return (sectionText.includes(exports.SECTION_MARKER) ||
...
exports.PROJECT_MD_SECTION = `## astria
